                ...
                <div className="w-full flex items-center justify-center lg:w-1/2">
                    ...
                    <h1 className="text-3xl font-semibold text-gray-600">LOG IN</h1>
                            <div className="mt-7">
                                ...
                                <div>
                                    <label className="text-lg font-medium text-blue-600">Password<span className="text-red-500">*</span></label>
                                    <input 
                                        className="w-full border-2 border-gray-100 rounded-l p-4 mt-1 bg-transparent"
                                ...
                                <div className='mt-8 flex flex-col gap-y-4'>
                                    <button className="active:scale-[.98] active:duration-75 hover:scale-[1.02] ease-in-out transition-all py-3 rounded-l bg-blue-500 text-white text-lg font-bold">Log in</button>
